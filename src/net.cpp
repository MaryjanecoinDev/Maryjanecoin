...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("maryjanecoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("maryjanecoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MaryJaneCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    {"maryjseed.earlz.net", "maryjseed.earlz.net"},
    {"chainz.cryptoid.info", "chainz.cryptoid.info"} //unsure if this actually has a node.. 
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("maryjanecoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("maryjanecoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("maryjanecoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("maryjanecoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MaryJaneCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("maryjanecoin-start");
