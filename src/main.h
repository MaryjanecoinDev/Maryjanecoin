...
static const int LAST_POW_BLOCK = 4320; // at 60 second blocks + Pos block will be about 14 days from launch
...
static const int64_t MAX_MONEY = 70000000 * COIN;
...
#define FOUNDATION "RWbvmCqtGcsiNxMEjL2p8j4MiSvt7HQiDU"
#define FOUNDATION_TEST "RWbvmCqtGcsiNxMEjL2p8j4MiSvt7HQiDU"
...
static const uint256 hashGenesisBlock("000000a88faca11a50a87269406546a4a8f0455cac9facbc239053f84648d802");
...
public:
    ...
    {
        // maryjanecoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // maryjanecoin: get transaction coin age
...
public:
    ...
    // maryjanecoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // maryjanecoin: two types of block: proof-of-work or proof-of-stake
    ...
    // maryjanecoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // maryjanecoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // maryjanecoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // maryjanecoin: block index flags
    enum  
    {
