...
// maryjanecoin: total coins staked (non-spendable until maturity)
...
// maryjanecoin: check 'spent' consistency between wallet and txindex
// maryjanecoin: fix wallet spent state according to txindex
...
// maryjanecoin: disable transaction (only for coinstake)
